...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_1,           KC_2,           KC_3,           KC_4,           KC_6,                                           KC_7,           KC_8,           KC_9,           KC_0,           KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [1] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_NO,          LALT(LGUI(LCTL(KC_F))),LGUI(LSFT(KC_SPACE)),LALT(LGUI(LCTL(KC_U))),KC_HOME,                                        KC_KP_EQUAL,    KC_KP_7,        KC_KP_8,        KC_KP_9,        KC_NO,          KC_TRANSPARENT, 
