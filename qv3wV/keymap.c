...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_voyager(
    ...
    LALT(LGUI(LCTL(KC_J))),KC_END,         KC_MS_BTN3,     DRAG_SCROLL,    KC_MS_BTN1,     KC_MS_BTN2,                                     KC_TILD,        KC_CIRC,        KC_LPRN,        KC_RPRN,        KC_DLR,         KC_TRANSPARENT, 
  ...
  [5] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_END,         KC_MS_BTN3,     DRAG_SCROLL,    KC_MS_BTN1,     KC_MS_BTN2,                                     KC_TILD,        KC_CIRC,        KC_LPRN,        KC_RPRN,        KC_DLR,         KC_TRANSPARENT, 
